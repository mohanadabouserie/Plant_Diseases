...
# Convert the images to RGB from BGR before displaying using Matplotlib
...
# Display final image after shadow removal
plt.subplot(1, 2, 2)
plt.imshow(final_image_rgb)
plt.title("Final Image (Shadow Removed)")
plt.axis('off')
